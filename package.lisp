...
(defpackage #:adp
  ...
  (:export #:header #:subheader #:subsubheader #:table-of-contents #:mini-table-of-contents #:text #:table
	   #:itemize #:image #:bold #:italic #:bold-italic #:code-inline #:web-link #:file-ref #:header-ref
	   #:symbol-ref #:function-ref #:type-ref #:code-tag #:code-block #:code-example #:defclass
	   #:defconstant #:defgeneric #:define-compiler-macro #:define-condition #:define-method-combination
	   ...
	   #:load-documentation-system #:cl-ref))
