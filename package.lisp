...
(defpackage #:adp
  ...
  (:export #:header #:subheader #:subsubheader #:table-of-contents #:mini-table-of-contents #:table-of-functions
	   #:table-of-symbols #:table-of-types #:text #:table #:itemize #:image #:bold #:italic #:bold-italic
