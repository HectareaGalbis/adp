...
;; definition
(define-writer-definer adppvt:*defclass-writer* define-defclass-writer (stream expr tag)
  "Define a function to print a defclass definition. It receives the stream, and the definition expression.")
(define-writer-definer adppvt:*defconstant-writer* define-defconstant-writer (stream expr tag)
  "Define a function to print a defconstant definition. It receives the stream, and the definition expression.")
(define-writer-definer adppvt:*defgeneric-writer* define-defgeneric-writer (stream expr tag)
...
(define-writer-definer adppvt:*define-condition-writer* define-define-condition-writer (stream expr tag)
...
(define-writer-definer adppvt:*define-modify-macro-writer* define-define-modify-macro-writer (stream expr tag)
...
(define-writer-definer adppvt:*define-symbol-macro-writer* define-define-symbol-macro-writer (stream expr tag)
  "Define a function to print a define-symbol-macro definition. It receives the stream, and the definition expression.")
(define-writer-definer adppvt:*defmacro-writer* define-defmacro-writer (stream expr tag)
...
(define-writer-definer adppvt:*defparameter-writer* define-defparameter-writer (stream expr tag)
...
(define-writer-definer adppvt:*defstruct-writer* define-defstruct-writer (stream expr tag)
  "Define a function to print a defstruct definition. It receives the stream, and the definition expression.")
(define-writer-definer adppvt:*deftype-writer* define-deftype-writer (stream expr tag)
  "Define a function to print a deftype definition. It receives the stream, and the definition expression.")
(define-writer-definer adppvt:*defun-writer* define-defun-writer (stream expr tag)
  "Define a function to print a defun definition. It receives the stream, and the definition expression.")
(define-writer-definer adppvt:*defvar-writer* define-defvar-writer (stream expr tag)
