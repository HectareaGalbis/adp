<h1 id="USER-GUIDE-HEADER4">The ADP User Guide</h1>
...
* [The ADP User Guide](/docs/user-guide.md#USER-GUIDE-HEADER4)
  * [Setting up ADP](/docs/user-guide.md#SETTING-UP-SUBHEADER-SEGUNDO6)
  * [Selecting a file to write in](/docs/user-guide.md#G292649)
  * [Functions to generate the API](/docs/user-guide.md#G293150)
  * [Functions to generate guides\.](/docs/user-guide.md#G294351)
    * [Headers](/docs/user-guide.md#HEADERS-SUBSUBHEADER10)
* [This is a header](/docs/user-guide.md#G295152)
  * [This is a subheader](/docs/user-guide.md#G295253)
    * [This is a subsubheader](/docs/user-guide.md#G295354)
    * [Text](/docs/user-guide.md#G295455)
    * [Tables](/docs/user-guide.md#G296256)
    * [Lists](/docs/user-guide.md#G297757)
    * [Text enrichment](/docs/user-guide.md#G298558)
    * [Images](/docs/user-guide.md#G299759)
    * [Code blocks](/docs/user-guide.md#G300560)
  * [Generating the documentation](/docs/user-guide.md#G303161)
  * [Cross references](/docs/user-guide.md#TAGS-SUBHEADER21)
    * [Header\-tags](/docs/user-guide.md#G304062)
    * [Function\-tags\, symbol\-tags and type\-tags](/docs/user-guide.md#FUNCTION-TAGS-SUBSUBHEADER23)
    * [Code\-tags](/docs/user-guide.md#G307363)
    * [Quoting\, commenting\, hiding and removing your code](/docs/user-guide.md#G310564)
  * [Tips and final comments](/docs/user-guide.md#G319165)
...
Same as with [ADP\:DEFUN](/docs/user-api.md#macro-defun)\, every macro that defines something is redefined to print documentation\. You can see every macro here\: [API reference functions](/docs/user-api.md#API-SUBHEADER27)
...
<h1 id="G295152">This is a header</h1>
...
Go to the top\: [The ADP User Guide](/docs/user-guide.md#USER-GUIDE-HEADER4)
...
* <strong><em>Read the API</em></strong>\: Maybe reading [ADP User Interface](/docs/user-api.md#USER-API-HEADER1) can make you understand better how some macros work \(or not\)\. At least\, you may be interested in seeing the section [Additional functions](/docs/user-api.md#ADDITIONAL-FUNCTIONS-SUBHEADER28) or [Macro characters](/docs/user-api.md#MACRO-CHARACTERS-SUBHEADER29)\.
...
Go back to [Function\-tags\, symbol\-tags and type\-tags](/docs/user-guide.md#FUNCTION-TAGS-SUBSUBHEADER23)
