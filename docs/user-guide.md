...
Go to the top\: [The ADP User Guide](/docs/user-guide.md#ADP:USER-GUIDE-HEADER)
...
* <strong><em>Read the API</em></strong>\: Maybe reading [ADP User Interface](/docs/user-api.md#ADP:USER-API-HEADER) can make you understand better how some macros work \(or not\)\. At least\, you may be interested in seeing the section [Additional functions](/docs/user-api.md#ADP:ADDITIONAL-FUNCTIONS-SUBHEADER) or [Macro characters](/docs/user-api.md#ADP:MACRO-CHARACTERS-SUBHEADER)\.
...
Go back to [Function\-tags\, symbol\-tags and type\-tags](/docs/user-guide.md#ADP:FUNCTION-TAGS-SUBSUBHEADER)
