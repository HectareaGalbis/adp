...
(DEFMACRO ADP:WEB-LINK (ADP::NAME ADP::LINK)
  (WHEN ADP-PRIVATE:*ADD-DOCUMENTATION*
    (ALEXANDRIA:WITH-GENSYMS (ADP::LET-NAME ADP::LET-LINK STREAM)
      `(LET ((,ADP::LET-NAME ,ADP::NAME) (,ADP::LET-LINK ,ADP::LINK))
         (DECLARE (TYPE STRING ,ADP::LET-NAME ,ADP::LET-LINK))
         (WITH-OUTPUT-TO-STRING (,STREAM)
           (FUNCALL ADP::*WEB-LINK-PROC* ,STREAM ,ADP::LET-NAME
                    ,ADP::LET-LINK))))))
```
...
(DEFUN ADP:LOAD-DOCUMENTATION-SYSTEM
  ...
  (LET ((ADP::STYLE-SYSTEM
         (INTERN (CONCATENATE 'STRING "ADP/" (SYMBOL-NAME ADP::STYLE))
                 :KEYWORD)))
    (ASDF/OPERATE:LOAD-SYSTEM ADP::STYLE-SYSTEM))
