...
(DEFMACRO ADP:HEADER (ADP::STR &OPTIONAL ADP::LABEL)
  (WHEN ADP-PRIVATE:*ADD-DOCUMENTATION*
    (CHECK-TYPE ADP::STR STRING "a string")
    (CHECK-TYPE ADP::LABEL (OR NULL SYMBOL) "a symbol")
    `(PROGN
      ,@(WHEN ADP::LABEL
...
#### ***Macro*** ADP:BOLD-ITALIC

```Lisp
(DEFMACRO ADP:BOLD-ITALIC (&REST ADP::ARGS)
  (WHEN ADP-PRIVATE:*ADD-DOCUMENTATION*
    `(ADP-PRIVATE:CREATE-BOLD-ITALIC-TEXT ,@ADP::ARGS)))
```
...
(DEFMACRO ADP:WEB-LINK (ADP::NAME ADP::LINK)
  (WHEN ADP-PRIVATE:*ADD-DOCUMENTATION*
    (CHECK-TYPE ADP::NAME STRING "a string")
    (CHECK-TYPE ADP::LINK STRING "a string")
...
(DEFMACRO ADP:HEADER-REF (ADP::LABEL)
  (WHEN ADP-PRIVATE:*ADD-DOCUMENTATION*
    (CHECK-TYPE ADP::LABEL SYMBOL "a symbol")
...
(DEFMACRO ADP:DEFUN (&BODY ADP::DEFUN-BODY)
  `(PROGN
    ,@(WHEN ADP-PRIVATE:*ADD-DOCUMENTATION*
        `((WHEN (SYMBOLP (CAR ',ADP::DEFUN-BODY))
...
(DEFMACRO ADP:WRITE-IN-FILE (ADP::FILE-PATH)
  (WHEN ADP-PRIVATE:*ADD-DOCUMENTATION*
    (CHECK-TYPE ADP::FILE-PATH PATHNAME "a pathname")
...
(DEFUN ADP:LOAD-DOCUMENTATION-SYSTEM
       (ADP::SYSTEM ADP::STYLE &REST ADP::STYLE-ARGS)
  (ASSERT (ASDF/SYSTEM:FIND-SYSTEM ADP::SYSTEM) (ADP::SYSTEM)
          "The system ~s was not found." ADP::SYSTEM)
  (ADP-PRIVATE:REMOVE-CURRENT-PROCS)
  (LET ((ADP::STYLE-SYSTEM
         (INTERN (CONCATENATE 'STRING "ADP/" (SYMBOL-NAME ADP::STYLE))
                 :KEYWORD)))
    (ASSERT (ASDF/SYSTEM:FIND-SYSTEM ADP::STYLE-SYSTEM) (ADP::STYLE-SYSTEM)
            "The style ~s was not found." ADP::STYLE-SYSTEM)
  ...
  (LET* ((ADP::ROOT-PATH (ASDF/SYSTEM:SYSTEM-SOURCE-DIRECTORY ADP::SYSTEM))
         (ADP::FIXED-ROOT-PATH
          (MAKE-PATHNAME :HOST (PATHNAME-HOST ADP::ROOT-PATH) :DEVICE
                         (PATHNAME-DEVICE ADP::ROOT-PATH) :DIRECTORY
                         (PATHNAME-DIRECTORY ADP::ROOT-PATH))))
