...
(defmacro define-tagged-definition-element-print (type writer)
  (with-gensyms (element stream expr tag)
    `(defmethod element-print ((,element ,type) ,stream)
       (with-slots ((,expr expr) (,tag tag)) ,element
	 (funcall ,writer ,stream ,expr ,tag)))))

(define-tagged-definition-element-print defclass-definition *defclass-writer*)
(define-tagged-definition-element-print defconstant-definition *defconstant-writer*)
(define-tagged-definition-element-print defgeneric-definition *defgeneric-writer*)
(define-definition-element-print define-compiler-macro-definition *define-compiler-macro-writer*)
(define-tagged-definition-element-print define-condition-definition *define-condition-writer*)
(define-definition-element-print define-method-combination-definition *define-method-combination-writer*)
(define-tagged-definition-element-print define-modify-macro-definition *define-modify-macro-writer*)
(define-definition-element-print define-setf-expander-definition *define-setf-expander-writer*)
(define-tagged-definition-element-print define-symbol-macro-definition *define-symbol-macro-writer*)
(define-tagged-definition-element-print defmacro-definition *defmacro-writer*)
...
(define-tagged-definition-element-print defparameter-definition *defparameter-writer*)
(define-definition-element-print defsetf-definition *defsetf-writer*)
(define-tagged-definition-element-print defstruct-definition *defstruct-writer*)
(define-tagged-definition-element-print deftype-definition *deftype-writer*)
(define-tagged-definition-element-print defun-definition *defun-writer*)
(define-tagged-definition-element-print defvar-definition *defvar-writer*)
